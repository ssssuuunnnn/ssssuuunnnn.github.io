---
layout: post
title:  "站在大神的肩膀上開發，19萬顆星的 Matt Pocock 工作流程"
...
上次用了 Superpowers 這個 Skill 之後，就想說還有沒有其他厲害的 Skill 可以挖，結果真的找到一個外國神——由 Matt Pocock 推出的 [mattpocock/skills](https://github.com/mattpocock/skills)，在 GitHub 上已經衝到 19 萬顆星。這個專案包含了從前期需求對齊到下游實作的一整套輕量化、組合式技能集，比起單一技能，更值得看的是它怎麼把整條流程串起來。
...
資料來源：[mattpocock/skills](https://github.com/mattpocock/skills)、[Matt Pocock](https://github.com/mattpocock)
